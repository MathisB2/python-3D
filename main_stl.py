...
def rech_max(L):
    #Recherche la valeur maximale de la liste L et retourne cette valeur si elle existe, None sinon
    if len(L)>0:
        m=max(L)
...
mesh = mesh.Mesh.from_file('sphere 80 faces.stl')
